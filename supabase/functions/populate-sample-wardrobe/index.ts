...
serve(async (req) => {
  ...
  try {
    ...
    const sampleClothing = [
      ...
      { name: "Red Flannel Shirt", category: "tops", color: "Red", brand: "L.L.Bean", photo_url: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop" },
      ...
      { name: "Green Cargo Pants", category: "bottoms", color: "Green", brand: "Carhartt", photo_url: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop&sat=-50" },
      { name: "Burgundy Dress Pants", category: "bottoms", color: "Burgundy", brand: "Calvin Klein", photo_url: "https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=400&h=400&fit=crop&sat=100" },
      ...
      { name: "Green Hiking Boots", category: "shoes", color: "Green", brand: "Merrell", photo_url: "https://images.unsplash.com/photo-1544966503-7cc5ac882d5f?w=400&h=400&fit=crop&hue=120" },
      ...
      { name: "Green Field Jacket", category: "outerwear", color: "Green", brand: "Barbour", photo_url: "https://images.unsplash.com/photo-1578116922645-3976907bf4ec?w=400&h=400&fit=crop&hue=120" },
      ...
      { name: "White Windbreaker", category: "outerwear", color: "White", brand: "Patagonia", photo_url: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop&sat=-100" },
      { name: "Red Puffer Jacket", category: "outerwear", color: "Red", brand: "North Face", photo_url: "https://images.unsplash.com/photo-1578116922645-3976907bf4ec?w=400&h=400&fit=crop&hue=0" },
      { name: "Tan Trench Coat", category: "outerwear", color: "Tan", brand: "Banana Republic", photo_url: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=400&h=400&fit=crop&sat=50" },
      { name: "Charcoal Suit Jacket", category: "outerwear", color: "Charcoal", brand: "Hugo Boss", photo_url: "https://images.unsplash.com/photo-1594223274512-ad4803739b7c?w=400&h=400&fit=crop&sat=-100" },
      ...
      { name: "White Summer Dress", category: "dresses", color: "White", brand: "Mango", photo_url: "https://images.unsplash.com/photo-1594723634896-f049b3fe5c54?w=400&h=400&fit=crop" },
      ...
      { name: "Navy Work Dress", category: "dresses", color: "Navy", brand: "Banana Republic", photo_url: "https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?w=400&h=400&fit=crop&hue=240" },
      { name: "Pink Evening Dress", category: "dresses", color: "Pink", brand: "ASOS", photo_url: "https://images.unsplash.com/photo-1596783074918-c84cb06531ca?w=400&h=400&fit=crop&hue=320" },
      { name: "Gray Sweater Dress", category: "dresses", color: "Gray", brand: "Uniqlo", photo_url: "https://images.unsplash.com/photo-1594723634896-f049b3fe5c54?w=400&h=400&fit=crop&sat=-50" },
      { name: "Yellow Sundress", category: "dresses", color: "Yellow", brand: "Target", photo_url: "https://images.unsplash.com/photo-1594223274512-ad4803739b7c?w=400&h=400&fit=crop&hue=60" },
      { name: "Purple Midi Dress", category: "dresses", color: "Purple", brand: "COS", photo_url: "https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=400&h=400&fit=crop&hue=270" },
    ]
